...
namespace MidiSheetMusic
{
    ...
    public class SheetMusic : Control
    {
        ...
        private SolidBrush deselectedShadeBrush = new SolidBrush(Color.LightGray); /** The brush for shading deselected areas */
        private Pen pen;                /** The black pen for drawing */

        public int SelectionStartPulse { get; set; }
        public int SelectionEndPulse { get; set; }
        ...
        protected /*override*/ void OnPaint(PaintEventArgs e)
        {
            ...
            foreach (Staff staff in staffs)
            {
                ...
                else
                {
                    ...
                    staff.Draw(g, clip, pen, SelectionStartPulse, SelectionEndPulse, deselectedShadeBrush);
                    g.TranslateTransform(0, -ypos);
                }
