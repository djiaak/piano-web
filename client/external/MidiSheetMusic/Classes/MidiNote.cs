...
namespace MidiSheetMusic
{
    ...
    {
        private int id;          /** Note ID. This can be used to keep track of clones after calls such as MidiFile.ChangeMidiNotes  */
        ...
        private int velocity;    /** Velocity of the note, from 0 to 127 */


        /* Create a new MidiNote.  This is called when a NoteOn event is
         * encountered in the MidiFile.
         */
        public MidiNote(int id, int starttime, int channel, int notenumber, int duration, int velocity)
        {
            this.id = id;
        ...
        {
            return new MidiNote(id, starttime, channel, notenumber, duration, velocity);
        }
